...
import com.axelfrache.daydash.service.AccountService
import com.axelfrache.daydash.service.MeService
...
class MeController(
    ...
    ): ResponseEntity<MeStatsResponse> {
        val user =
    ...
    fun getProfile(
        @AuthenticationPrincipal userDetails: UserDetails,
    ): ResponseEntity<MeProfileResponse> {
        val user =
            userRepository.findByUsername(userDetails.username)
                ?: throw ResourceNotFoundException("Utilisateur introuvable")
